...
class UploadSftp:
    ...
    def notify_lab(self, batch_name, lab_code, receiver_email, email_psswd=None, zip_passwd=None, zip_filename=None):
        """
            ...
            if zip_path:
                ...
                if success:
                    ...
                    # After successful upload, send the results email
                        ...
                        lab_code = cod
                        self.notify_lab(batch_data['batch'], lab_code, receiver_email, zip_passwd=password, zip_filename=zip_filename)