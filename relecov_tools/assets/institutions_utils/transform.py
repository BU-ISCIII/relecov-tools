...
for index, row in df.iterrows():
    ...
    json_dict[hospital_name] = {
        ...
        "collecting_institution_email": row['EMAIL'].strip() if not pd.isna(row['EMAIL']) else "Desconocido",
        "collecting_institution_finalidad": to_title_case(row['FINALIDAD_ASISITENCIAL']),
